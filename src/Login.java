...
public class Login extends JFrame implements ActionListener {
    ...
    public Login() {
        ...
        btnLogin = new JButton("Login",new ImageIcon(getClass().getClassLoader().getResource("Images/login.PNG")));
        ...
        if (e.getSource() == btnLogin) {
            try {
               ...
               Connection con = Settings.getDBConnection();
                ...
                JOptionPane.showMessageDialog(null,x.toString(), "Connection error", JOptionPane.ERROR_MESSAGE);
