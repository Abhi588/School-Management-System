...
public class frmAdminMDI extends JFrame implements ActionListener {
   ...
   // private JMenuItem mnuStudentAttendance;
    ...
    public frmAdminMDI() {
        ...
        setIconImage(new ImageIcon(getClass().getClassLoader().getResource("images/appicon.png")).getImage());
        ...
        //mnuStudentAttendance = new JMenuItem("StudentAttendance");

        mnuAccounts.add(mnuNewUser);
        mnuNewUser.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F2, KeyEvent.ALT_MASK));
        mnuNewUser.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/user.png")));
        mnuAccounts.add(mnuEditUser);
        mnuEditUser.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_F3, KeyEvent.ALT_MASK));
        mnuEditUser.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/editusr.png")));
        ...
        mnuDeleteUser.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/delusr.png")));
        mnuStdDetails.add(mnuNewReg);
        mnuNewReg.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_N, KeyEvent.CTRL_MASK));
        mnuNewReg.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/newreg.png")));
        mnuStdDetails.add(mnuEditReg);
        mnuEditReg.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_E, KeyEvent.CTRL_MASK));
        mnuEditReg.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/editreg.png")));
        mnuStdDetails.add(mnuDelDetails);
        mnuDelDetails.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D, KeyEvent.CTRL_MASK));
        mnuDelDetails.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/delreg.png")));
        ...
        mnuEditMark.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/editmark.png")));
        mnuView.add(mnuMarkList);
        mnuMarkList.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, KeyEvent.CTRL_MASK));
        mnuMarkList.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/marklist.png")));
        mnuView.add(mnuMemList);
        mnuMemList.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_S, KeyEvent.CTRL_MASK));
        mnuMemList.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/memlist.png")));
        mnuView.add(mnuViewStdDetails);
        mnuViewStdDetails.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T, KeyEvent.CTRL_MASK));
        mnuViewStdDetails.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/stddet.png")));
        ...
        mnuCalc.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/calc.png")));
        mnuTools.add(mnuNotepad);
        mnuNotepad.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U, KeyEvent.CTRL_MASK));
        mnuNotepad.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/notepad.png")));
       // mnuAttendance.add(mnuStudentAttendance);
        ...
        //mnuStudentAttendance.addActionListener(this);
