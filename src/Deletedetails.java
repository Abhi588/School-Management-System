...
public class Deletedetails extends JInternalFrame implements ActionListener {
    ...
    public Deletedetails() {
        ...
        btnDelete = new JButton("Delete", new ImageIcon(getClass().getClassLoader().getResource("Images/delusr.png")));
        btnDelete.setEnabled(false);
        btnCancel = new JButton("Cancel", new ImageIcon(getClass().getClassLoader().getResource("Images/cancel.png")));
        btnView = new JButton("View", new ImageIcon(getClass().getClassLoader().getResource("Images/view.png")));
